...
const content = `# G5 - Bézier cubic spline
...
- "\`I\` and \`J\` can be omitted, which results in these offsets being zero. This produces a 3-point spline (try the [interactive demo](https://www.geogebra.org/m/WPHQ9rUt)). However, \`P\` and \`Q\` are required (otherwise you just get a linear movement)."
