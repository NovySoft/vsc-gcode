...
- \`[T<extruder>]\`: Optional extruder number. If omitted, current extruder (or ALL extruders with [FILAMENT_UNLOAD_ALL_EXTRUDERS](https://marlinfw.org/docs/configuration/configuration.html#advanced-pause)).
